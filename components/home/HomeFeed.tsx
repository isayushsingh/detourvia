...
import { Creator, LocationGroup, Trip } from '@/types/schema';
import { Search, ArrowRight, ChevronLeft, ChevronRight } from 'lucide-react';

const ITEMS_PER_PAGE = 10; 
interface HomeFeedProps {
  initialTrips: (Trip & { creator: Creator })[]; // Data passed from server
}

export default function HomeFeed({ initialTrips }: HomeFeedProps) {
  ...
  const allTripsEnriched = initialTrips;
