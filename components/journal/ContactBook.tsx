...
export default function ContactBook({ contacts }: { contacts: Contact[] }) {
  ...
  return (
    <div className="mt-8">
      ...
      {/* GRID UPDATE: 
         - 'grid-cols-2': Makes them sit side-by-side (smaller width) on mobile/tablet.
         - 'lg:grid-cols-1': Stacks them back to 1 column when inside the narrow Desktop sidebar.
      */}
